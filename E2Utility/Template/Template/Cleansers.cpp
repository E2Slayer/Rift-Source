	...
	Menu::Tree("Cleansers", "Activator.Cleansers", false, []()
	{
		...
		Menu::Tree("Cleanse", "Activator.Cleansers.Cleanse", false, []()
		{
			...
			Menu::Tree("Cleanse Config", "Activator.Cleansers.CleanseConfig", false, []()
			{
				...
				Menu::Checkbox("Use Cleanse On Flee", "Activator.Cleansers.CleanseUseFlee", true);
		...
		Menu::Tree("Quick Silver Sash/Mercurial Scimitar", "Activator.Cleansers.QSS", false, []()
		{
			...
			Menu::Tree("QSS Config", "Activator.Cleansers.QSSConfig", false, []()
			{
				...
				Menu::Checkbox("Use QSS On Flee", "Activator.Cleansers.QSSUseFlee", true);
...
void Cleansers::CleanseCheck()
{
	...
	if (Menu::Get<int>("Activator.Cleansers.CleanseStyle") == 0 || (Menu::Get<int>("Activator.Cleansers.CleanseStyle") == 1 && Menu::Get<Hotkey>("Activator.Config.ComboKey").Active))
	{
		...
		if (Menu::Get<bool>("Activator.Cleansers.CleanseUseSlow") && Player.HasBuffType((unsigned char)BUFF_TYPE_SLOW) && Player.GetBuffByType((unsigned char)BUFF_TYPE_STUN).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_STUN).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.CleanseUseSlowDuration") / 1000.0f ||
			...
			Menu::Get<bool>("Activator.Cleansers.CleanseUseFear") && Player.HasBuffType((unsigned char)BUFF_TYPE_FEAR) && !Player.HasBuffType((unsigned char)BUFF_TYPE_FLEE) && Player.GetBuffByType((unsigned char)BUFF_TYPE_FEAR).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_FEAR).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.CleanseUseFearDuration") / 1000.0f ||
			Menu::Get<bool>("Activator.Cleansers.CleanseUseFlee") && Player.HasBuffType((unsigned char)BUFF_TYPE_FLEE) && !Player.HasBuffType((unsigned char)BUFF_TYPE_FEAR) && Player.GetBuffByType((unsigned char)BUFF_TYPE_FLEE).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_FLEE).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.CleanseUseFleeDuration") / 1000.0f ||
...
void Cleansers::QSSCheck(int targetID, SpellSlot itemSlot)
{
	...
	if (Menu::Get<int>("Activator.Cleansers.QSSStyle") == 0 || (Menu::Get<int>("Activator.Cleansers.QSSStyle") == 1 && Menu::Get<Hotkey>("Activator.Config.ComboKey").Active))
	{
		...
		if (Menu::Get<bool>("Activator.Cleansers.QSSUseSlow") && Player.HasBuffType((unsigned char)BUFF_TYPE_SLOW) && Player.GetBuffByType((unsigned char)BUFF_TYPE_SLOW).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_SLOW).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.QSSUseSlowDuration") / 1000.0f ||
			...
			Menu::Get<bool>("Activator.Cleansers.QSSUseFear") && Player.HasBuffType((unsigned char)BUFF_TYPE_FEAR) && !Player.HasBuffType((unsigned char)BUFF_TYPE_FLEE) && Player.GetBuffByType((unsigned char)BUFF_TYPE_FEAR).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_FEAR).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.QSSUseFearDuration") / 1000.0f ||
			Menu::Get<bool>("Activator.Cleansers.QSSUseFlee") && Player.HasBuffType((unsigned char)BUFF_TYPE_FLEE) && !Player.HasBuffType((unsigned char)BUFF_TYPE_FEAR) && Player.GetBuffByType((unsigned char)BUFF_TYPE_FLEE).EndTime - Player.GetBuffByType((unsigned char)BUFF_TYPE_FLEE).StartTime >= (float)Menu::Get<int>("Activator.Cleansers.QSSUseFleeDuration") / 1000.0f ||
