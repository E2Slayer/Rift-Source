...
void Defensives::Init()
{
	...
	DefensivesItemList.emplace_back(ItemStruct((int)ItemID::GargoyleStoneplate, "Gargoyle Stoneplate", "GargoyleStoneplate", subCategoryDef, MenuTypes::MyHealth , SpellTypes::Active, 1200.0f));
	DefensivesItemList.emplace_back(ItemStruct((int)ItemID::SeraphsEmbrace, "Seraphs Embrace", "SeraphsEmbrace", subCategoryDef, MenuTypes::MyHealth , SpellTypes::Active, 1200.0f));
	DefensivesItemList.emplace_back(ItemStruct((int)ItemID::Stopwatch, "Stopwatch", "Stopwatch", subCategoryDef, MenuTypes::MyHealth , SpellTypes::Active, 1200.0f));
	DefensivesItemList.emplace_back(ItemStruct((int)ItemID::ZhonyasHourglass, "Zhonyas Hourglass", "ZhonyasHourglass", subCategoryDef, MenuTypes::MyHealth, SpellTypes::Active, 1200.0f));
