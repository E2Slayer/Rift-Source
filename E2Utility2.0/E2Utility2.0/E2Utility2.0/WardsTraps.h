...
const enum WardTypes { Green, Pink, Trap, Trinket, Blue };
...
struct WardStruct
{
	...
	WardStruct(float _Duration, float _Range, float _VisionRange, const char* _ObjectBaseSkinName, const char* _SpellName, WardTypes _Type)
...
struct WardObject
{
	...
	inline Vector3 RealPosition(Vector3 end) const
	{
...
public:
	...
	void OnObjectCreated(void* object, unsigned int netID, void* userData) override;
	void OnObjectRemoved(void* object, unsigned int netID, void* userData) override;
